...
public interface Buildable {
    ...
    List<BlockPos> trace(Player player, BlockHitResult hitResult, boolean skipRaytrace);

    //Fired continuously for visualization purposes
    List<BlockPos> preview(Player player, BlockHitResult hitResult, boolean skipRaytrace);
