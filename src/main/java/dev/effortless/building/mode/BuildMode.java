...
import dev.effortless.building.mode.builder.Builder;
import dev.effortless.building.mode.builder.oneclick.Disable;
import dev.effortless.building.mode.builder.oneclick.Single;
import dev.effortless.building.mode.builder.threeclick.*;
