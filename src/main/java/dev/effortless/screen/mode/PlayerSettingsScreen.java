...
import dev.effortless.screen.widget.ExtendedButton;
import dev.effortless.screen.widget.Slider;
...
public class PlayerSettingsScreen extends Screen {
    ...
    public PlayerSettingsScreen() {
        super(Component.translatable(Effortless.asKey("screen", "player_settings")));
    }
