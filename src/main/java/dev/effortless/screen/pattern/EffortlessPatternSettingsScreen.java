package dev.effortless.screen.pattern;
...
//			}
        ...
        private Component getDisplayName(Pattern pattern) {
            if (pattern.isEmpty()) {
                return Component.literal(String.valueOf(ChatFormatting.GRAY) + ChatFormatting.ITALIC + "Empty Pattern" + ChatFormatting.RESET);
            }
